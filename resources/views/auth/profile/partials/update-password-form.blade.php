<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6 pt-3">
        @csrf
        @method('put')
        ...
        <div class="form-group">
            <x-input-label for="update_password_password_confirmation" :value="__('Confirmer votre nouveau mot de passe')" />
